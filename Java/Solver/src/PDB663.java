...
public class PDB663 {
    ...
    public PDB663() {
        try {
            data663[0] = loadData("./Java/Solver/db/663/0_1_2_3_4_5.csv");
            data663[1] = loadData("./Java/Solver/db/663/8_9_10_12_13_14.csv");
            data663[2] = loadData("./Java/Solver/db/663/6_7_11.csv");
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
